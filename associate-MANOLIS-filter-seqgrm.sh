...
matrix_bfile="/lustre/scratch114/projects/helic/checkpoints/total_grm/ldpruned.hwe/allchr/allchr"
...
echo "Generating GRM..."
hsub 10g -I $plink --memory 10000 --bfile $matrix_bfile --pheno tmp.phenodata --out matrixinput.$phenotype --make-bed --hwe 1e-4
...
do
    echo /nfs/team144/it3/Software_farm3/gemma-0.94/bin/gemma -bfile input/$i -n 1 -notsnp  -maf 0  -miss 1  -km 1 -k matrix/matrix.BMI.cXX.txt -lmm 4 -o $i
