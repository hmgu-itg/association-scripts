...
tabix -s 1 -b 3 -e 3 -S 1 MANOLIS.$phenotype.assoc.txt.gz
gsub 10g -I -q yesterday ~ag15/scripts/man_qq_annotate --chr-col chr --pos-col ps --auto-label --pval-col p_score --title "MANOLIS-$phenotype" --sig-thresh 1e-08 --sig-thresh-line 1e-08 MANOLIS.$phenotype.assoc.txt.gz MANOLIS.$phenotype.assoc

awk '$7>0.001' MANOLIS.$phenotype.assoc.txt | bgzip > MANOLIS.$phenotype.maf0.001.assoc.txt.gz
tabix -s 1 -b 3 -e 3 -S 1 MANOLIS.$phenotype.maf0.001.assoc.txt.gz
gsub 10g -I -q yesterday ~ag15/scripts/man_qq_annotate --chr-col chr --pos-col ps --auto-label --pval-col p_score --title "MANOLIS-$phenotype-MAF0.001" --sig-thresh 1e-08 --sig-thresh-line 1e-08 MANOLIS.$phenotype.maf0.001.assoc.txt.gz MANOLIS.$phenotype.maf0.001.assoc
