...
do
    echo /nfs/team144/it3/Software_farm3/gemma-0.94/bin/gemma -bfile input/$i -n 1 -notsnp  -maf 0  -miss 1  -km 1 -k /lustre/scratch114/projects/helic/checkpoints/assoc_test/phenotypes/$phenotype/matrix/plink.matrix.rel -lmm 4 -o $i
